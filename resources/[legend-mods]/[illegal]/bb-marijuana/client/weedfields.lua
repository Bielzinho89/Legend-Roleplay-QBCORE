...
function searchPlant(entity)
	...
	local finished = exports["reload-skillbar"]:taskBar(math.random(5000,7500),math.random(1,1))
    if finished ~= 100 then
		QBCore.Functions.Notify("Failed to Harvest Plant...", "error", 3500)
		ClearPedTasks(playerPed)
    else
		local finished2 = exports["reload-skillbar"]:taskBar(math.random(2500,5000),math.random(1,1))
        if finished2 ~= 100 then
			QBCore.Functions.Notify("Failed to Harvest Plant...", "error", 3500)
			ClearPedTasks(playerPed)
        else
			local finished3 = exports["reload-skillbar"]:taskBar(math.random(900,2000),math.random(1,1))
