...
Config.SafeRewards = { -- It will pick a random combination from this table. type = 'item' or 'cash'
	[1] = {
		...
		{type = 'item', itemName = 'markedbills', itemQty = math.random(1,2)},
	},
	[2] = {
		{type = 'item', itemName = 'markedbills', itemQty = math.random(1000,2000)},
	},
	[3] = {
...
Config.ItemsReward = { -- It will pick a random combination from this table.
	[1] = {
		{type = 'item', itemName = 'diamond', itemQty = math.random(1,2)},
		{type = 'item', itemName = 'markedbills', itemQty = math.random(1,2)},
		{type = 'item', itemName = 'markedbills', itemQty = math.random(1,2)},
	},
	
	[2] = {
		{type = 'item', itemName = 'markedmoney', itemQty = math.random(100,200)},
	},
	
	[3] = {
		{type = 'item', itemName = 'markedmoney', itemQty = math.random(100,200)},
		{type = 'item', itemName = 'markedbills', itemQty = 1},
	},
}
...
RegisterNetEvent('rl_houserobbery:notification')
AddEventHandler('rl_houserobbery:notification', function(msg)
