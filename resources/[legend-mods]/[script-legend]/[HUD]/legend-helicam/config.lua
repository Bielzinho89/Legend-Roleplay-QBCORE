...
Config.DateFormat = 2 -- 0 = MM/DD/YY, 1 = DD/MM/YY, 2 = YY/MM/DD, 3 = DD-Mon-YYYY
...
Config.ShowLicensePlate = false -- (LPL)
Config.CheckLicensePlateAngle = false -- If true, it checks the angle between the helicopter camera and the plate. This reasults in player beeing unable to get a license plate read when the camera can't clearly see the plate.
...
Config.ShowMessageIfWrongJob = false -- If true, it will display an error message of you attempt to enter the camer without the right job, if false no message, just won't allow you to enter
...
Config.Spotlight = {
    ...
    MaxDistance = 1000.0,                    -- The maximum distance the spotlight will glow
...
Config.Localisation = {
    -- Notifications
    Notification = {
        JobNotWhitelisted = "Você não possui o emprego necessário!",
        JobGrade = "Seu nível de emprego é muito baixo!",
        NoCameraHeli = "Este helicóptero não tem câmera!",
        NoCameraPlane = "Este avião não tem câmera!",
        IsPilot = "Você não pode usar a câmera enquanto é o piloto!",
        NotInRear = "Você precisa estar na parte traseira do helicóptero para usar a câmera!",
        CameraInUse = "Alguém já está usando a câmera!",
        SpotlightInUse = "Alguém já está usando o holofote da câmera!",
        NoSpotlight = "Este helicóptero não tem um holofote!",
        SpotlightGlobalLimit = "O limite global de holofotes foi atingido!",
        CannotRappelFromHeli = "Este helicóptero não suporta rapel!",
        CannotRappelFromSeat = "Você não pode fazer rapel deste assento!",
        ToHighToRappel = "O helicóptero está muito alto para fazer rapel!",
        ConfirmRappel = "Tem certeza de que deseja fazer rapel? (Pressione novamente para confirmar)",
        Rappeling = "Fazendo rapel!"
    },
    -- Blip Names
    Blip = {
    ...
    KeyMapping = {
        ToggleCam = "Helicam - Alternar Câmera",
        AttemptLock = "Helicam - Tentar Travar",
        CycleVision = "Helicam - Alternar Visão",
        -- ToggleMarker = "Helicam - Adicionar/Remover Marcadores",
        Rappel = "Helicam - Rappel do Helicóptero",
        Spotlight = "Helicam - Alternar Holofote",
        SpotlightBrightness = "Helicam - (+ rolagem) Ajustar Brilho do Holofote",
        SpotlightRadius = "Helicam - (+ rolagem) Ajustar Raio do Holofote",
        Postals = "Helicam - Alternar Postais"
    },
    ChatSuggestions = {
...
Config.Helicopters = {
    ...
    -- AS350
    [1346171487] = {
        offset = vector3(-0.65, 2.25, -1.45),
        labels = { -- Liveries
        [0] = "GRUPAMENTO TATICO AEREO LEGEND", -- 0 is default
    }
    },
    -- NOVO
    [387442212] = {
        offset = vector3(0.0, 1.25, -1.1),
        labels = { -- Liveries
        [0] = "GRUPAMENTO TATICO AEREO LEGEND", -- 0 is default
    }
    },
