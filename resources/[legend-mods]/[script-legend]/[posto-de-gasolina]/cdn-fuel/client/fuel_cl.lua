		...
		if Config.PlayerOwnedGasStationsEnabled and not Config.UnlimitedFuel and not RefuelingType == 'special' then
			if ReserveLevels < maxfuel then
				...
				fuel = exports['qb-input']:ShowInput({
					header = "Escolha a qtd. de combustível<br>Valor atual: $" ..
					FuelPrice .. "/L<br> Combustível atual: " .. finalfuel .. " Litros <br> Valor para encher o tanque: $" ..
					...
					inputs = { {
						...
						isRequired = true,
						name = 'amount',
						text = 'Limite do tanque: '..ReserveLevels..' litros.'
					}}
				})
			else
				fuel = exports['qb-input']:ShowInput({
					...
					inputs = { {
						...
						isRequired = true,
						name = 'amount',
						text = 'Limite do tanque: ' .. maxfuel .. ' litros.'
					}}
				})
			end
		else
			fuel = exports['qb-input']:ShowInput({
				header = "Escolha a qtd. de combustível<br>Valor Local: $" ..
				FuelPrice .. "/L<br> Combustível atual: " .. finalfuel .. " Litros <br> Valor para encher o tanque: $" ..
				wholetankcostwithtax .. "",
				submitText = Lang:t("input_insert_nozzle"),
				inputs = { {
