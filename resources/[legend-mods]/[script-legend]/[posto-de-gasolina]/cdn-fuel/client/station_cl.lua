        ...
        if CanOpen then
            ...
            if Config.Ox.Input then
                local reserves = lib.inputDialog('Purchase Reserves', {
					...
					default = '$'.. Config.FuelReservesPrice .. ' Por Litro',
					disabled = true },
					{ type = "input", label = 'Estoque Atual',
					default = Currentreserveamount,
					disabled = true },
					{ type = "input", label = 'Comprar Combustível',
					default = Config.MaxFuelReserves - Currentreserveamount,
					disabled = true },
					{ type = "slider", label = 'Encher Estoque: $' ..math.ceil(GlobalTax((Config.MaxFuelReserves - Currentreserveamount) * Config.FuelReservesPrice) + ((Config.MaxFuelReserves - Currentreserveamount) * Config.FuelReservesPrice)).. '',
					default = Config.MaxFuelReserves - Currentreserveamount,
					min = 0,
            ...
            if Config.Ox.Menu then
                    ...
                    options = {
                        {
                            ...
                            description = 'Comprar sua reserva aqui!',
                        ...
                        },
                        {
                            ...
                            description = "Eu gostaria de trocar o valor do Litro do meu posto!",
                            icon = "fas fa-usd",
                            arrow = false, -- puts arrow to the right
                ...
                exports['qb-menu']:openMenu({
                    ...
                    },
                    {
                        ...
                        icon = "fas fa-usd",
                        txt = "Valor atual: $"..StationFuelPrice..Lang:t("input_alter_fuel_price_header_2") ,
                        params = {
                            event = "cdn-fuel:stations:client:changefuelprice",
                            args = {
                                location = location,
