...
Config.RefuelTime = 50 -- Highly recommended to leave at 600. This value will be multiplied times the amount the player is fueling for the progress bar and cancellation logic! DON'T GO BELOW 250, performance WILL drop!
...
Config.Ox = {
    Inventory = false, -- Uses OX_Inventory's metadata instead of lj-inventory's.
