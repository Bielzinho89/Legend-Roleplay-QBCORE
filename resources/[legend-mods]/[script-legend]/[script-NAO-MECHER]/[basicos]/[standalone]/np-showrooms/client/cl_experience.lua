...
CreateNPC = function()
  created_ped = CreatePed(5, GetHashKey('s_m_m_highsec_02') , -33.47, -1103.75, 25.42, 71.65, false, true)
...
Citizen.CreateThread(function()
  exports['qb-target']:AddCircleZone("hospitalstash", vector3(-33.5, -1103.71, 26.42), 0.3, {
    name = "hospitalstash",
    --radius = 0.3
    debugPoly = false,
    --heading=250,
