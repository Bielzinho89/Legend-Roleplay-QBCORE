    ...
    while true do
        ...
        if IsControlPressed(0, Config.WeaponKeyBind) then
            if currentMode == "Automatic" then
                currentMode = "Single"
                QBCore.Functions.Notify("Changed weapon mode to Single")
            elseif currentMode == "Single" then
                currentMode = "Burst"
                QBCore.Functions.Notify("Changed weapon mode to Burst")
            elseif currentMode == "Burst" then
                currentMode = "Automatic"
                QBCore.Functions.Notify("Changed weapon mode to Automatic")
            end
        end
