...
Config.Locations = {                -- Edit the various interaction points for players or create new ones
    ['checking'] = {
        [1] = vector3(-671.58, 328.64, 83.89),
        [2] = vector3(-254.54, 6331.78, 32.43), -- paleto
    },
    ['duty'] = {
        [1] = vector3(-667.29, 328.1, 83.19),
    ...
    ['beds'] = {
        { coords = vector4(-685.73, 326.77, 84.01, 270.89),    taken = false, model = 1631638868 },
        { coords = vector4(-686.49, 321.95, 84.01, 264.86),  taken = false, model = 1631638868 },
        { coords = vector4(-681.84, 321.56, 84.01, 85.4),   taken = false, model = 2117668672 },
        { coords = vector4(-681.37, 325.07, 84.01, 82.62),    taken = false, model = 2117668672 },
        { coords = vector4(-681.21, 328.74, 84.01, 69.08),   taken = false, model = 2117668672 },
        { coords = vector4(-680.85, 332.11, 84.01, 78.68),  taken = false, model = -1091386327 },
        { coords = vector4(-685.61, 332.55, 84.01, 271.08),  taken = false, model = -1091386327 },
        { coords = vector4(-684.95, 337.7, 84.01, 245.88),  taken = false, model = -1091386327 },
        { coords = vector4(-680.48, 337.4, 84.01, 128.38),  taken = false, model = -1091386327 },
    },
    ['jailbeds'] = {
